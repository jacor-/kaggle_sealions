...
batch_size = 20
seconds_to_start_pulling_data = 0
image_size_nn = 45
...
RANDOM_SAMPLES_PER_IMAGE = 500000 # Samples we are going to throw
MAX_NUMBER_OF_FILES_PER_IMAGE, SAMPLES_PER_FILE = 10, 250 # MAX 1000 samples per file
...
TRAIN_MAX_CASES_IN_FOLDER = 1000
TRAIN_CASES_TO_GENERATE_PER_EXECUTION = 5
TRAIN_NUM_WORKERS = 3
#TRAIN_cases = ['616']
TRAIN_available_cases = cases[:-num_images_for_validation]
VALID_MAX_CASES_IN_FOLDER = 100
VALID_CASES_TO_GENERATE_PER_EXECUTION = 5
VALID_NUM_WORKERS = 1
#VALID_cases = ['616']
VALID_available_cases = cases[-num_images_for_validation:]
...
## path_to_store_files
folder_to_store_cases = '%s/seal_generated_data_patches' % settings.DATAMODEL_PATH
